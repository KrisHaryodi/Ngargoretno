          ...
          <table id="example2" class="table table-bordered table-hover">
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <div class="btn-group">
                    <a href="<?php echo $super_url; ?>adminweb.php?module=edit_artikel&id_artikel=<?php echo $mbr['id_artikel'];?>"
                      class="btn btn-warning">
                      <i class='fa fa-pencil'></i>
                    </a>
                    <a href="<?php echo $super_url; ?>module/artikel/aksi_hapus.php?id_artikel=<?php echo $mbr['id_artikel'];?>"
