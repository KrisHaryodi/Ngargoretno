...
if (empty($_SESSION['username']) AND empty($_SESSION['passuser'])) {
	...
	if(!empty($lokasifile)){
		...
		echo "<script>alert('Data Berhasil Diedit'); window.location = '$super_url'+'adminweb.php?module=artikel';</script>";
		}else{
		echo "<script>alert('Data Gagal Diedit'); window.location = '$super_url'+'adminweb.php?module=artikel';</script>";
		}
	}else{
