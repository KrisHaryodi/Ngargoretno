...
if (empty($_SESSION['username']) AND empty($_SESSION['passuser'])) {
	...
	if ($queryEdit) {
		echo "<script> alert('Data Berhasil Diedit'); window.location = '$super_url'+'adminweb.php?module=sosmed';</script>";
	} else {
		echo "<script> alert('Data Gagal Diedit'); window.location = '$super_url'+'adminweb.php?module=edit_sosmed&id_sosmed='+'$id_sosmed';</script>";
	}
}
 ?>