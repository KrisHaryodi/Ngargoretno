              ...
              <table id="example2" class="table table-bordered table-hover">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group">
                                <a href="<?php echo $super_url; ?>adminweb.php?module=edit_paketwisata&id_wisata=<?php echo $mbr['id_wisata'];?>" class="btn btn-warning">
                                  <i class='fa fa-pencil'></i>
                                </a>
                                <a href="<?php echo $super_url; ?>module/paketwisata/aksi_hapus.php?id_wisata=<?php echo $mbr['id_wisata'];?>" onClick="return confirm('Anda yakin ingin menghapus data ini?')" class="btn btn-danger">
