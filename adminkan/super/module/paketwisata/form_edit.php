	...
	<div class="row">
		<div class="col-md-6">
			<div class="box box-info">
				...
				<form method="post" class="form-horizontal" action="../../adminkan/super/module/paketwisata/aksi_edit.php" enctype="multipart/form-data">
					...
					<div class="box-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" id="harga" name="harga" placeholder="" value="<?php echo $harga; ?>">
							</div>
						</div>
                        ...
                        <div>
                            ...
                            <textarea class="textarea" placeholder="Deskripsi Paket Wisata" style="width: 100%; height: 125px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" name="deskripsi"><?php echo $deskripsi; ?>
                        	</textarea>
                        </div>
					</div>
                    	</div>
