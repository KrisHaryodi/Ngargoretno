              ...
              <table id="example2" class="table table-bordered table-hover">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo $mbr['wisata_deskripsi'];?></td>
                        <td><img src="img/<?php echo $mbr['wisata_foto'];?>" height="100" width="150"></td>
                        
                        <td>
                            <div class="btn-group">
                                <a href="<?php echo $admin_url; ?>adminweb.php?module=edit_paketwisata&id_wisata=<?php echo $mbr['id_wisata'];?>" class="btn btn-warning">
                                  <i class='fa fa-pencil'></i>
                                </a>
                                <a href="<?php echo $admin_url; ?>module/paketwisata/aksi_hapus.php?id_wisata=<?php echo $mbr['id_wisata'];?>" onClick="return confirm('Anda yakin ingin menghapus data ini?')" class="btn btn-danger">
