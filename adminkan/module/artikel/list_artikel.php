              ...
              <table id="example2" class="table table-bordered table-hover">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group">
                                <a href="<?php echo $admin_url; ?>adminweb.php?module=edit_artikel&id_artikel=<?php echo $mbr['id_artikel'];?>" class="btn btn-warning">
                                  <i class='fa fa-pencil'></i>
                                </a>
                                <a href="<?php echo $admin_url; ?>module/artikel/aksi_hapus.php?id_artikel=<?php echo $mbr['id_artikel'];?>" onClick="return confirm('Anda yakin ingin menghapus data ini?')" class="btn btn-danger">
