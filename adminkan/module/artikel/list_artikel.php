          ...
          <table id="example2" class="table table-bordered table-hover">
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <?php echo substr($mbr['artikel_isi'],0,200);?>...
                </td>
                <td><img src="img/<?php echo $mbr['artikel_foto'];?>" height="100" width="150"></td>

                <td>
                  <div class="btn-group">
                    <a href="<?php echo $admin_url; ?>adminweb.php?module=edit_artikel&id_artikel=<?php echo $mbr['id_artikel'];?>"
                      class="btn btn-warning">
                      <i class='fa fa-pencil'></i>
                    </a>
                    <a href="<?php echo $admin_url; ?>module/artikel/aksi_hapus.php?id_artikel=<?php echo $mbr['id_artikel'];?>"
