...
if(empty($_SESSION['username']) AND empty($_SESSION['passuser'])){
  ...
  include "../../../../lib/koneksi.php";
	...
	if ($querySimpan) {
		echo "<script> alert('Data Berhasil Ditambahkan'); window.location = '$admin_url' +'adminweb.php?module=sosmed';</script>";
	} else {
		echo "<script> alert('Data Gagal Ditambahkan'); window.location = '$admin_url' +'adminweb.php?module=tambah_sosmed';</script>";
	}
}
 ?>