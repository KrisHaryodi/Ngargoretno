					...
					<table class="table table-hover">
						<tbody>
								...
								<tr>
									...
									<td>
										<div class="btn-group">
											<a href="<?php echo $admin_url;?>adminweb.php?module=edit_sosmed&id_sosmed=<?php echo $form['id_sosmed'];?>">
												<button class='btn btn-warning'>
													<i class='fa fa-pencil'></i>
												</button>
											</a>
											<a href="<?php echo $admin_url;?>module/customerservice/sosmed/aksi_hapus.php?id_sosmed=<?php echo $form['id_sosmed'];?>" onClick="return confirm('Anda yakin ingin menghapus data ini?')">
