...
if (empty($_SESSION['username']) AND empty($_SESSION['passuser'])) {
	...
	if ($queryEdit) {
		echo "<script> alert('Data Berhasil Diedit'); window.location = '$admin_url'+'adminweb.php?module=cust';</script>";
	} else {
		echo "<script> alert('Data Gagal Diedit'); window.location = '$admin_url'+'adminweb.php?module=edit_cust&id_cust='+'$id_cust';</script>";
	}
}
 ?>