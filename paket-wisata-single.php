        ...
        <div class="clv_footer_wrapper clv_section">
                                ...
                                <div class="footer_slider_arrows">
                                    <span class="footer_arrow footer_left">
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink" width="6px" height="10px">
                                    ...
                                    <span class="footer_arrow footer_right">
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink" width="7px" height="10px">
                                            <path fill-rule="evenodd" fill="rgb(182, 182, 182)"
                    ...
                    <div class="col-md-3 col-lg-3">
                        <div class="footer_block">
                            ...
                            <ul class="useful_links">
                                <li><a href="produk.php"><span><i class="fa fa-angle-right"
                                                aria-hidden="true"></i></span>Produk</a></li>
                                <li><a href="paket-wisata.php"><span><i class="fa fa-angle-right"
                                                aria-hidden="true"></i></span>Paket Wisata</a></li>
                                <li><a href="blog.php"><span><i class="fa fa-angle-right"
                                                aria-hidden="true"></i></span>Blog</a></li>
                                <li><a href="tentang-kami.php"><span><i class="fa fa-angle-right"
                                                aria-hidden="true"></i></span>Tentang Kami</a></li>
                                <li><a href="kontak.php"><span><i class="fa fa-angle-right"
                                                aria-hidden="true"></i></span>Kontak</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-md-3 col-lg-3">
            ...
            ?>
                            <p><span><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        ...
                                        <defs>
                                            <filter id="Filter_0">
                                                <feFlood flood-color="rgb(247, 142, 33)" flood-opacity="1"
                                                    result="floodOut" />
            ...
            ?>
                            <ul class="agri_social_links">
                                <li><a href="https://<?php echo $abot['sosmed_facebook'];?>"><span><i
                                                class="fa fa-facebook" aria-hidden="true"></i></span></a></li>
                                <li><a href="https://<?php echo $abot['sosmed_twitter'];?>"><span><i
                                                class="fa fa-twitter" aria-hidden="true"></i></span></a></li>
                                <li><a href="https://<?php echo $abot['sosmed_instagram'];?>"><span><i
                                                class="fa fa-instagram" aria-hidden="true"></i></span></a></li>
                                <li><a href="https://<?php echo $abot['sosmed_youtube'];?>"><span><i
                                                class="fa fa-youtube-play" aria-hidden="true"></i></span></a></li>
                            </ul>
                            <?php
                }
                        ?>
                ...
                <center>
                    <img src="images/logo/kemendikbud.png" alt="image"
                        style="width: 75px; height: 65px; object-fit: contain;">
                    <img src="images/logo/favicon.png" alt="image"
                        style="width: 75px; height: 65px; object-fit: contain;">
