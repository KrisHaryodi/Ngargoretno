            ...
            ?>
                                        <li>
                                            <div class="post_image">
                                                <img src="admin/img/<?php echo $abot['wisata_foto'];?>" alt="image" style="width: 75px; height: 65px; object-fit: cover;">
                                            </div>
                                            <div class="post_content">
                                                <p>Rp.<?php echo $abot['wisata_harga'];?></p>
                                                <a href="<?php echo $base_url;?>paket-wisata-single.php?id_wisata=<?php echo $abot['id_wisata'];?>"><?php echo $abot['wisata_nama'];?></a>
                                            </div>
                                        </li>
                                        <?php
                    }
