					...
					<div class="clv_slide">
						<div class="container">
							<div class="clv_slide_inner" >
								...
								<a href="<?php echo $base_url;?>blog-single.php?id_artikel=<?php echo $abot['id_artikel'];?>" class="clv_btn2">read more</a>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="row">
				<div class="col-md-6 col-lg-6">
					<div class="about_agri_image">
						<img src="adminkan/img/<?php echo $abot['profile_foto'];?>" alt="image" style="width: 530px; height: 570px; object-fit: cover;">
					</div>
				</div>
				<div class="col-md-6 col-lg-6">
								...
								<div class="swiper-slide">
									<div class="shop_slide">
										<div class="item_image">
											<img src="adminkan/img/<?php echo $abot['produk_sampul'];?>" alt="image" class="img-fluid" style="width: 173px; height: 173px; object-fit: cover;">
										</div>
										...
										<div class="item_overlay">
											<h5><?php echo $abot['produk_nama'];?></h5>
											<a href="<?php echo $base_url;?>produk-single.php?id_produk=<?php echo $abot['id_produk'];?>" class="shop_btn">lihat produk</a>
										</div>
									</div>
								</div>
                                <?php
            ...
            ?>
				<div class="col-md-4 col-lg-4">
					<div class="feature_block">
						<div class="item_image">
							<img src="adminkan/img/<?php echo $abot['wisata_foto'];?>" alt="image" class="img-fluid" style="width: 320px; height: 320px; object-fit: cover;" >
						</div>
						<br>
						<h3><?php echo $abot['wisata_nama'];?></h3>
						<p><?php echo substr ($abot['wisata_deskripsi'],0,200);?></p>
						<a href="<?php echo $base_url;?>paket-wisata-single.php?id_wisata=<?php echo $abot['id_wisata'];?>" class="clv_btn">read more</a>
					</div>
				</div>
                <?php
                    }
					...
					<div class="col-lg-6 col-md-6">
						<div class="blog_section">
							...
							<div class="agri_blog_content">
								<h3><a href="<?php echo $base_url;?>blog-single.php?id_artikel=<?php echo $abot['id_artikel'];?>"><?php echo $abot['artikel_judul'];?></a></h3>
								<div class="blog_user">
									<div class="user_name">
								...
								<a href="<?php echo $base_url;?>blog-single.php?id_artikel=<?php echo $abot['id_artikel'];?>">read more <span><i class="fa fa-long-arrow-right" aria-hidden="true"></i></span></a>
							</div>
						</div>
					</div>
                    <?php
            ...
            ?>
							<div class="right_blog_block">
								<div class="right_blog_image">
									<img src="adminkan/img/<?php echo $abot['artikel_foto'];?>" alt="image" style="width: 230px; height: 285px; object-fit: cover;" />
								</div>
		...
		<div class="container">
									...
									<div class="swiper-slide">
										<div class="footer_post_slide">
											<div class="footer_post_image">
                                                <img src="adminkan/img/<?php echo $abot['artikel_foto'];?>" alt="image" style="width: 75px; height: 65px; object-fit: cover;">
											</div>
											<div class="footer_post_content">
												<span><?php echo $abot['artikel_tgl'];?></span>
												<p><a href="<?php echo $base_url;?>blog-single.php?id_artikel=<?php echo $abot['id_artikel'];?>"><?php echo $abot['artikel_judul'];?></a></p>
											</div>
										</div>
									</div>
                                    <?php
				...
				<div class="col-md-3 col-lg-3">
					<div class="footer_block">
						...
						<ul class="useful_links">
							<li><a href="produk.php"><span><i class="fa fa-angle-right" aria-hidden="true"></i></span>Produk</a></li>
							<li><a href="paket-wisata.php"><span><i class="fa fa-angle-right" aria-hidden="true"></i></span>Paket Wisata</a></li>
							<li><a href="blog.php"><span><i class="fa fa-angle-right" aria-hidden="true"></i></span>Blog</a></li>
							<li><a href="tentang-kami.php"><span><i class="fa fa-angle-right" aria-hidden="true"></i></span>Tentang Kami</a></li>
							<li><a href="kontak.php"><span><i class="fa fa-angle-right" aria-hidden="true"></i></span>Kontak</a></li>
						</ul>
					</div>
				</div>
				<div class="col-md-3 col-lg-3">
            ...
            ?>
						<p><span><svg 
								...
								</svg></span> <?php echo $abot['contact_alamat'];?></p>
						<p><span><svg 
								 xmlns="http://www.w3.org/2000/svg"
								 xmlns:xlink="http://www.w3.org/1999/xlink"
								...
								</svg></span> <?php echo $abot['contact_hp'];?></p>
						<p><span><svg 
							 xmlns="http://www.w3.org/2000/svg"
							 xmlns:xlink="http://www.w3.org/1999/xlink"
							 width="16px" height="16px">
							...
							</svg></span> <?php echo $abot['contact_email'];?></p>
                        <?php
                }
                        ?>
                        <?php
            ...
            ?>
						<ul class="agri_social_links">
							<li><a href="https://<?php echo $abot['sosmed_facebook'];?>"><span><i class="fa fa-facebook" aria-hidden="true"></i></span></a></li>
							<li><a href="https://<?php echo $abot['sosmed_twitter'];?>"><span><i class="fa fa-twitter" aria-hidden="true"></i></span></a></li>
							<li><a href="https://<?php echo $abot['sosmed_instagram'];?>"><span><i class="fa fa-instagram" aria-hidden="true"></i></span></a></li>
							<li><a href="https://<?php echo $abot['sosmed_youtube'];?>"><span><i class="fa fa-youtube-play" aria-hidden="true"></i></span></a></li>
						</ul>
                        <?php
                }
                        ?>
