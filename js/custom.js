...
(function($) {
    ...
    var cultivation = {
        ...
        HomeTravelPacketSlider: function() {
            var swiper = new Swiper('.packet_travel_slider .swiper-container', {
                slidesPerView: 4,
                spaceBetween: 15,
                loop: true,
                autoplay: {
                ...
                navigation: {
                    nextEl: '.travel_packet_right',
                    prevEl: '.travel_packet_left',
                },
                breakpoints: {
                    // when window width is <= 320px
                    320: {
...
document.addEventListener('DOMContentLoaded', function() {
    let app = document.querySelector('#currentYear');
    let d = new Date();
