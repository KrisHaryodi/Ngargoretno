...
// $id_artikel = mysql_real_escape_string($_GET['id_artikel']);
// $queryEdit = mysqli_query($konek, "SELECT * FROM tbl_artikel WHERE id_artikel=".$id_artikel);
// $hasilQuery = mysqli_fetch_array($queryEdit);

$stmt = $mysqli->prepare("SELECT * FROM tbl_artikel WHERE id_artikel = ?");
$stmt->bind_param("i", $_GET['id_artikel']);
$stmt->execute();
                        ...
                        <div class="blog_left_section">
                            <div class="blog_section">
                                <div class="agri_blog_image">
                                    ...
                                    KUDU DI CROP
                                     -->
                                    <img src="admin/img/<?php echo $foto; ?>" alt="image" style="width: 870px; height: 410px; object-fit: cover;">
