                                        ...
                                        <div class="product_item_block">
                                            <div class="org_product_block">
                                                <div class="org_product_image">
                                                    <img src="adminkan/img/<?php echo $abot['produk_sampul'];?>"
                                                        alt="image"
                                                ...
                                                <a
                                                    href="<?php echo $base_url;?>produk-single.php?id_produk=<?php echo $abot['id_produk'];?>">detail
                                                    produk</a>
                                            </div>
                    ...
                    <div class="col-md-3 col-lg-3">
                        <div class="footer_block">
                            ...
                            <ul class="useful_links">
                                <li>
                                    <a href="produk.php"><span><i class="fa fa-angle-right"
                                                aria-hidden="true"></i></span>Produk</a>
                                </li>
                                <li>
                                    <a href="paket-wisata.php"><span><i class="fa fa-angle-right"
                                                aria-hidden="true"></i></span>Paket
                                        Wisata</a>
                                </li>
                                <li>
                                    <a href="blog.php"><span><i class="fa fa-angle-right"
                                                aria-hidden="true"></i></span>Blog</a>
                                </li>
                                <li>
                                    <a href="tentang-kami.php"><span><i class="fa fa-angle-right"
                                                aria-hidden="true"></i></span>Tentang
                                        Kami</a>
                                </li>
                                <li>
                                    <a href="kontak.php"><span><i class="fa fa-angle-right"
                                                aria-hidden="true"></i></span>Kontak</a>
                                </li>
                            </ul>
                        </div>
                    </div>
