                                    ...
                                    <div class="product_item_block">
                                        <div class="org_product_block">
                                            ...
                                            <div class="org_product_image">
                                                <img src="adminkan/img/<?php echo $abot['produk_sampul'];?>" alt="image" style="width: 173px; height: 173px; object-fit: cover;">
                                            </div>
                                            <h4><?php echo $abot['produk_nama'];?></h4>
                                            <h3><span></span>Rp.<?php echo $abot['produk_harga'];?></h3>
                                            <a href="<?php echo $base_url;?>produk-single.php?id_produk=<?php echo $abot['id_produk'];?>">detail produk</a>
                                        </div>
                                        <div class="content_block">
                                            <div class="product_price_box"> 
                                                <h3><?php echo $abot['produk_nama'];?></h3>            
                                                <h5><span></span>Rp.<?php echo $abot['produk_harga'];?></h5>   
                                            </div>
                                            
                                            
                                            <p><?php echo $abot['produk_cerita'];?></p>
                                            <p><?php echo $abot['produk_deskripsi'];?></p>
                                        </div>
                                    </div>
                                </li>
                                <?php
