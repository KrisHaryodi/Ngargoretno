			...
			<div class="container">
				<div class="row">
					<?php
						...
						$data = mysqli_query($konek,"SELECT * FROM tbl_wisata");
						$num_of_data = mysqli_num_rows($data);
						$num_of_page = ceil($num_of_data / $page_size);

						$kueriAbout= mysqli_query($konek, "SELECT * FROM tbl_wisata ORDER BY id_wisata DESC LIMIT $initial_index, $page_size");
