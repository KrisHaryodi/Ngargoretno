    ...
    <div class="clv_features_wrapper clv_section">
        <div class="container">
            ...
            <div class="row">
                ...
                $kueriAbout= mysqli_query($konek, "SELECT * FROM tbl_wisata ORDER BY id_wisata DESC");
                while ($abot=mysqli_fetch_array($kueriAbout)) {
            ?>
                <div class="col-md-4 col-lg-4">
                    <div class="feature_block">
                        <div class="item_image">
                            <img src="admin/img/<?php echo $abot['wisata_foto'];?>" alt="image" class="img-fluid" style="width: 320px; height: 320px; object-fit: cover;">
                        </div>
                        <br>
	...
	<div class="search_box">
		<div class="search_block">
			...
			<div class="search_field">
				...
				<a href="paket-wisata-single.php">search</a>
			</div>
		</div>
    ...
    <div class="thankyou_wrapper">
        <div class="thankyou_inner">
            ...
            <div class="download_button">
                <a href="paket-wisata-single.php" class="clv_btn">download PDF</a>
